  ...
  return (
    <>
      ...
      <Container>
        <main>
          {/* HERO SECTION */}
          <section className="py-14 lg:py-20 px-5 lg:px-[120px] flex flex-col gap-6 lg:gap-10">
            {/* TOP */}
            <article className="">
          ...
          {/* RECENT WORKS */}
          <section className="px-5 lg:px-[120px] py-14 lg:pt-14 lg:pb-[108px] flex flex-col gap-6 lg:gap-14">
            {/* TEXT */}
